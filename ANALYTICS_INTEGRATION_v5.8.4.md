...
Sự kiện chính: session_start/end, page_view, character_open, profile_open, timeline_view, narration_play, ask_question, whatif_question, roleplay_start/new_scenario/choice/end, language_change.
